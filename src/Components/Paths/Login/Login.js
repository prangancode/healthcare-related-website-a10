...
const Login = () => {
    ...
    return (
        <div>
            <div className="bg-indigo-100 flex items-center justify-center min-h-screen lg:p-20 sm:p-0">
                <Fade top>
                    <div className="bg-white p-20 rounded shadow-lg border-4 border-indigo-800 sm:w-11/12 lg:w-2/3">
                        ...
                        <h2 className="text-3xl text-center font-bold mb-10 text-gray-800">Please {toggle ? 'Register' : 'Login'}</h2>
                        ...
                        {toggle ? <form onSubmit={userWithEmailandPassword} className="space-y-5">
                            <div>
                                ...
                                <input onBlur={handleNameChange} id='inputName' type="text" placeholder="Your Name" className="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500" required />
                            </div>
                            <div>
                                <label className="block mb-1 font-bold text-gray-500">Email</label>
                                <input onBlur={email} type="email" placeholder="Your Email Address" className="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500" required />
                            </div>

                            <div>
                                <label className="block mb-1 font-bold text-gray-500">Password</label>
                                <input onBlur={password} type="password" placeholder="Create Your Password" className="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500" required />
                            </div>
                            ...
                            <form onSubmit={signWithEmailandPassword} className="space-y-5">
                                ...
                                <div>
                                    <label className="block mb-1 font-bold text-gray-500">Password</label>
                                    <input onBlur={password} type="password" placeholder="Your Account Password" className="w-full border-2 border-gray-200 p-3 rounded outline-none focus:border-purple-500" required />
                                </div>
                        ...
                        <div className='text-center'>
                            <div className='bg-blue-700 border-2 hover:ring-4 mb-3 mx-auto p-3 ring-2 ring-blue-400 rounded sm:w-11/12 lg:w-1/3'>
